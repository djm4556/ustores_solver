...
mono = {"XY": ((lambda x, d, n, a, b: bound(x + d)),
        ...
        "YW": ((lambda x, d, n, a, b: bound(2 * x + d - 35 * n)),
               ...
               (lambda x, d, n, a, b: bound(2 * x + abs(b) + abs(a) - 5 * pow(n, 3)))),  # FIXME: Module-side log bug
        ...
        "VU": ((lambda x, d, n, a, b: bound(n * x)),
               ...
               (lambda x, d, n, a, b: bound(n * (x - a + b)))),  # FIXME: Module-side computation bug (left 1/2 log=OK)
